...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_microsoft_speech_browser_sdk__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_microsoft_speech_browser_sdk___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_microsoft_speech_browser_sdk__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__entities__ = __webpack_require__(47);
...
class SpeechRecognition {
    ...
    handleHypothesis({ result, error }) {
        ...
        if (result.Text && this.onresult) {
            this.onresult.call(this.recognizer, Object(__WEBPACK_IMPORTED_MODULE_1__entities__["c" /* createResultEvent */])([Object(__WEBPACK_IMPORTED_MODULE_1__entities__["b" /* createIntermediateResult */])(result)]));
        }
    }
    handleResult({ result, error }) {
        ...
        const status = __WEBPACK_IMPORTED_MODULE_0_microsoft_speech_browser_sdk__["RecognitionStatus"][result.RecognitionStatus];
        switch (status) {
            case __WEBPACK_IMPORTED_MODULE_0_microsoft_speech_browser_sdk__["RecognitionStatus"].Success:
                if (this.onresult) {
                    const results = Object(__WEBPACK_IMPORTED_MODULE_1__entities__["a" /* createFinalResult */])(result.NBest, this.maxAlternatives);
                    this.onresult.call(this.recognizer, Object(__WEBPACK_IMPORTED_MODULE_1__entities__["c" /* createResultEvent */])([results]));
                }
                break;
            case __WEBPACK_IMPORTED_MODULE_0_microsoft_speech_browser_sdk__["RecognitionStatus"].Error:
                if (this.onerror) {
                    this.onerror.call(this, error);
                }
                break;
            case __WEBPACK_IMPORTED_MODULE_0_microsoft_speech_browser_sdk__["RecognitionStatus"].NoMatch:
                if (this.onnomatch) {
                    this.onnomatch.call(this, error);
                }
                // call onnomatch;
                break;
            case __WEBPACK_IMPORTED_MODULE_0_microsoft_speech_browser_sdk__["RecognitionStatus"].InitialSilenceTimeout:
            case __WEBPACK_IMPORTED_MODULE_0_microsoft_speech_browser_sdk__["RecognitionStatus"].EndOfDictation:
            case __WEBPACK_IMPORTED_MODULE_0_microsoft_speech_browser_sdk__["RecognitionStatus"].BabbleTimeout:
    ...
    setupRecognizer() {
        ...
        const speechConfig = new __WEBPACK_IMPORTED_MODULE_0_microsoft_speech_browser_sdk__["SpeechConfig"](new __WEBPACK_IMPORTED_MODULE_0_microsoft_speech_browser_sdk__["Context"](new __WEBPACK_IMPORTED_MODULE_0_microsoft_speech_browser_sdk__["OS"]('Speech', 'Speech', null), new __WEBPACK_IMPORTED_MODULE_0_microsoft_speech_browser_sdk__["Device"](navigator.userAgent, 'Browser', '1.0.0.0')));
        const recognitionMode = this.interimResults ? __WEBPACK_IMPORTED_MODULE_0_microsoft_speech_browser_sdk__["RecognitionMode"].Interactive : __WEBPACK_IMPORTED_MODULE_0_microsoft_speech_browser_sdk__["RecognitionMode"].Conversation;
        const language = Object(__WEBPACK_IMPORTED_MODULE_2__helpers__["a" /* resolveLang */])(this.lang);
        const resultFormat = __WEBPACK_IMPORTED_MODULE_0_microsoft_speech_browser_sdk__["SpeechResultFormat"].Detailed;
        // configure and authenticate recognizer
        const config = new __WEBPACK_IMPORTED_MODULE_0_microsoft_speech_browser_sdk__["RecognizerConfig"](speechConfig, recognitionMode, language, resultFormat);
        const auth = new __WEBPACK_IMPORTED_MODULE_0_microsoft_speech_browser_sdk__["CognitiveSubscriptionKeyAuthentication"](this.apiKey);
        // create and return recognizer based on the prepared configuration
        return Object(__WEBPACK_IMPORTED_MODULE_0_microsoft_speech_browser_sdk__["CreateRecognizer"])(config, auth);
    }
}
...
var ServiceTelemetryListener_Internal_1 = __webpack_require__(41);
var SpeechConnectionMessage_Internal_1 = __webpack_require__(42);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__entities_SpeechRecognitionEvent__ = __webpack_require__(48);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__entities_SpeechRecognitionResult__ = __webpack_require__(49);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__helpers_LanguageResolver__ = __webpack_require__(51);
